...
export class SkaleManagerInstance<ContractType> extends Instance<
    ContractType,
    SkaleManagerContractName
> {
    contractNames = Object.values(
        SkaleManagerContract,
    ) as SkaleManagerContractName[];
    ...
    async queryVersion() {
        return (await this.callSkaleManager("version", [])) as string;
    }
    ...
    async getContractAddress(
        ...
        const contractManagerAbi = await this.getContractAbi("ContractManager");
    ...
    getContract(
        ...
        return super.getContract(contractName, args);
    }
